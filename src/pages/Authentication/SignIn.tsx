...
const SignIn: React.FC = () => {
  ...
  const handlerLogin = () => {
    if (username == '' || password == '') {
      ...
      ApiIam.login({ username: username, password: password })
        .then((rs) => {
          const decodeJwt = decodeToken<DecodedToken>(rs.data.data.accessToken);
          console.log(decodeJwt);
          if (decodeJwt != null && decodeJwt.role == 'admin') {
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="text-xl font-bold mr-10">Kang-Admin</p>
