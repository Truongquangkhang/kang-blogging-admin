...
const renderUserAction = (
  ...
  <Stack direction="row" className="items-center w-full" spacing={1}>
    ...
    <Tooltip title="Change password">
      <div
        onClick={() => {
          changePasswordUser(params.row.id);
        }}
      >
        <IoLockClosedOutline className="hover:bg-slate-300" />
      </div>
    </Tooltip>
...
export { renderUserAction, renderUserAction2 };
